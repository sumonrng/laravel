            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="refer_id" class="col-md-4 col-form-label text-md-end">{{ __('Refer ID') }}</label>

                            <div class="col-md-6">
                                <input id="refer_id" type="text" class="form-control @error('refer_id') is-invalid @enderror" name="refer_id" value="{{ old('refer_id') }}" required autocomplete="refer_id" autofocus>
